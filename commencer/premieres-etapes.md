...
{% page-ref page="../features/editer-le-registre/gerer-votre-traitement.md" %}
...
{% page-ref page="../features/editer-le-registre/partager-le-registre.md" %}
...
![Action plan example](../.gitbook/assets/image%20%2865%29.png)
...
{% page-ref page="../features/notifier-les-violations-de-donnees/" %}
